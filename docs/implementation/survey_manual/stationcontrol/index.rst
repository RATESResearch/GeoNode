...
To ensure that the best horizontal and vertical coordinates to determine the elevation of the RATES Station NOAA NGS Online Processing User Service (OPUS) Shared Static Solutions will be used.
...
NOAA NGS OPUS Shared Solutions. 
--------------------
...
.. code-block:: yaml
1. Complete the NGS and RATE Tutorial on How to Submit an OPUS Share Observation
2. Refer to the referenced Documents for setting NGS Monuments and Submit an OPUS Share Observation
...
6. Place GNSS level on RATES Station Benchmark Control Point
7. Start Survey: Collect RINEX 3 data (Conversion from Vendor format to Rinex may occur in office download) for 4 hours and 15 minutes.
8. Occasionally check level of instrument and note time checked.  If off more then half bubble stop measuring.  Level and restart 4 hours and 15 minutes.
9. Complete `Observer Field Log for GNSS Surveys <https://geodesy.noaa.gov/surveys/forms/obslog-OPUS.pdf?>`_
  ...
  - Obtain measurements and description to find RATES Station Control
...
15. Place all Images and Observation Field Logs in \Station\01_BM\FIELD_NOTES
